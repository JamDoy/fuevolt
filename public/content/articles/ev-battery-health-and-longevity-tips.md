---
title: "EV Battery Health: How to Maximise Your Electric Car Battery Life"
...
Lithium-ion batteries lose capacity gradually over time and use cycles. Two types of degradation occur:

Calendar aging happens simply with the passage of time, even if the car sits unused. It is accelerated by high temperatures and storing the battery at very high or very low states of charge.

Cycle aging happens with each charge and discharge cycle. It is accelerated by deep discharges (running the battery very low), frequent full charges (charging to 100 per cent), fast charging at high power, and charging or discharging in extreme temperatures.
...
Avoid letting the battery sit at very low charge. Leaving your EV at 5 per cent for days or weeks accelerates calendar aging. If you are parking the car for an extended period, leave it at 50 to 60 per cent.

Park in the shade when possible. Extreme heat is the biggest enemy of lithium-ion batteries. Australian summers can push battery temperatures high, especially in direct sun. Parking in a garage, carport or shade reduces thermal stress.

Use the car's battery preconditioning feature. Many EVs can precondition (warm or cool) the battery while still plugged in, using mains power rather than battery power. This is especially useful before a fast-charging stop on a cold morning.
