...
writePage('/privacy', generatePage({
  ...
  content: `
        ...
        <p style="font-size:0.9rem;color:#4B5563;margin-bottom:8px">We use Google Analytics and Google advertising services (subject to Google's Privacy Policy), OpenStreetMap/Nominatim and Open Charge Map (subject to their respective terms), TomTom for routing, geocoding and traffic data (subject to TomTom's Privacy Policy), and DiscoverCars for the affiliate rental-car link and banner on the Trip Planner page — their affiliate network receives a tracking request when the banner is displayed, in addition to when you click through (subject to DiscoverCars' Privacy Policy).</p>
...
writePage('/terms', generatePage({
  ...
  content: `
        ...
        <h2 style="font-size:1.2rem;margin:20px 0 8px">Affiliate Links</h2>
        <p style="font-size:0.9rem;color:#4B5563;margin-bottom:8px">The Trip Planner page includes an affiliate link to DiscoverCars, a car rental comparison service. If you book through this link, FueVolt may earn a commission at no extra cost to you. FueVolt is not a party to any booking made through DiscoverCars.</p>
...
writePage('/trends', generatePage({
  ...
  content: `
        ...
        <p style="font-size:0.9rem;color:#4B5563;margin-bottom:16px">This keeps trend data accurate to what was actually reported, rather than estimated or backfilled. See our <a href="/privacy">Privacy Policy</a> for details on what's stored locally versus sent anywhere else.</p>
