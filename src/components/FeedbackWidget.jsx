...
// How long a visitor must be on the site before the floating button appears
// — avoids greeting someone who just landed with a request for feedback.
    ...
    <>
      {visible && (
        <button
          ...
          className="fixed bottom-3 right-3 z-[400] min-h-8 flex items-center gap-1.5 px-3 py-1 rounded-full font-semibold text-xs cursor-pointer"
