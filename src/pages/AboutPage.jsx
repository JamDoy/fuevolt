...
const DATA_SOURCES = [
  ...
  { label: 'Northern Territory Government', href: 'https://nt.gov.au/' },
];
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8" style={{ color: theme.text }}>
      ...
      <section className="mb-8">
        ...
        <p className="text-sm leading-relaxed mb-3" style={{ color: theme.textSecondary }}>
          FueVolt links its coverage to the original public authorities so drivers can review the source and reporting rules themselves. Current fuel-price coverage includes New South Wales, Victoria, Queensland, Western Australia, the Northern Territory and Tasmania (covered via the same government network as NSW). South Australia is not covered yet.
        </p>
